	...
	<div class="navbar-header">
	 ...
	 <div class="collapse navbar-collapse" id="myNavbar">
		<ul class="nav navbar-nav navbar-right">
	      <li><a href="#home"><span class="glyphicon glyphicon-lamp"></span> Home</a></li>
...
<div id="glimps" class="container-fluid sec" style="background-color: #fff">
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 section_image">
...
<div id="contact" class="container-fluid sec">
  ...
  <form action="#" method="post" id="contact_form" class="slideanim">
  	...
  	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
  			<textarea class="form-control" type="text" name="email" placeholder="MESSSAGE"></textarea>
  	</div>
  	<div col-lg-12>
