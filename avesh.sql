...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2017 at 07:44 PM
...
INSERT INTO `event_info` (`event_id`, `event_name`, `event_desc`, `event_date`, `first_price`, `second_price`, `venue`, `contact`, `parent_event`, `register_in`) VALUES
(2, 'Robo Soccer', 'this is the demo description', '2017-02-27 13:30:00', 5001, 2001, 'Central Hall', '9907595776', 'Robotics', 'robo_soccer'),
(3, 'Code Creater', 'This event will puzzle your mind and challenge the coder within you. We will provide you system as well as the software. You have to use your intellect to debug the code, or to find the output, or even make the entire program.', '2017-02-27 13:00:00', 2001, 1001, '', '7415151884', 'no', 'code_creater'),
(4, 'E-Strategy', ' E-STRATEGY is the flagship entrepreneurship event organized by the AVESH TechFest 2017 at Government Engineering College Raipur. The event will act as a platform to foster entrepreneurial spirit in participants through different rounds and levels.  Now the real time has come to show the world the hidden talents within you. Become an entrepreneur to solve problems and make an impact, never for the lifestyle of the glory.All you need is to ‘be you\'. The negotiating and planning skills run in Indian veins. Sometimes it comes up with “itna lagado na bhaiyya” and sometimes with seller’s attitude. So we present you a platform to estimate your fire and talents.', '2017-02-28 13:04:00', 2001, 1001, 'C-106', '7415997026', 'no', 'e_strategy'),
(5, 'Front End', 'A mix of programming and layout that powers the visuals and interactions of the web.Front-end web development is the practice of producing HTML, CSS, JavaScript and J-query for a website or Web Application so that a user can see and interact with them directly.', '2017-02-28 10:30:00', 1001, 501, '', '8085742314', 'Hashmap', 'front_end'),
(6, 'Graphic Designing', 'This event is based on your creativity in the digital canvas. We are going to provide you the desktop along with the installed software.You have to design the art with the provided theme ( for example Swachh Bharat) in limited time.', '2017-02-27 11:00:00', 1001, 501, 'C-209', '8602630414', 'HashMap', 'graphic_design'),
(7, 'Jugaad', 'The junkyard event tests your engineering aptitude of making a working model of machine out of a given pile of junk.', '2017-02-27 11:32:00', 5001, 2001, 'C-105', '9039640143', '', 'jugaad'),
(8, 'Nirmaan', 'This event is based on your creativity in the structural units. We are going to provide you the plot area for which you have to prepare the best suit plan and to present structural model of that in limited time. For which we will provide you material required for its fabrication.', '2017-02-27 13:23:00', 3001, 1001, 'C-106', '', 'Stratum', 'nirmaan'),
(9, 'Parikalpana', 'didn\'t got the info yet', '2017-02-27 00:00:00', 2001, 2001, 'C-105', '', '', 'parikalpana'),
(10, 'Quiz', '', '2017-02-27 10:05:00', 2001, 1001, 'Central Hall', '9589851715', '', 'quiz'),
(11, 'Robo Dangal', 'Just like WWE it’s a wrestling battle against two bots. The opponent bot has to push another bot towards the hurdles in the arena to reduce their points. More time taken to get out of a hurdle, more you will lose your points. So, come experience the live “DANGAL” between the Bots.', '2017-02-27 11:00:00', 5001, 3001, 'Central Hall', '7725043274', 'Robotics', 'robo_dangal'),
...
--
-- Table structure for table `parikalpana`
--

CREATE TABLE `parikalpana` (
  `id` int(11) NOT NULL,
  `Participant_name` varchar(100) NOT NULL,
  `college_name` varchar(200) NOT NULL,
  `roll_no` varchar(30) NOT NULL,
...
--
-- Indexes for table `parikalpana`
--
ALTER TABLE `parikalpana`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `nirmaan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `parikalpana`
--
ALTER TABLE `parikalpana`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
